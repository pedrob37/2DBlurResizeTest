...
# @torch.jit.script
def grid_pull(inp, grid, bound: List[int], interpolation: List[int], extrapolate: int):
    """
...
# @torch.jit.script
def grid_push(inp, grid, shape: Optional[List[int]], bound: List[int], interpolation: List[int], extrapolate: int):
    """
    inp: (B, C, *spatial_in) tensor
...
# @torch.jit.script
def grid_count(grid, shape: Optional[List[int]], bound: List[int], interpolation: List[int], extrapolate: int):
    """
    grid: (B, *spatial_in, D) tensor
    shape: List{D}[int] tensor, optional, default=spatial_in
    bound: List{D}[int] tensor
...
# @torch.jit.script
def grid_grad(inp, grid, bound: List[int], interpolation: List[int], extrapolate: int):
    """
    inp: (B, C, *spatial_in) tensor
    grid: (B, *spatial_out, D) tensor
    bound: List{D}[int] tensor
...
# @torch.jit.script
def grid_pushgrad(inp, grid, shape: List[int], bound: List[int], interpolation: List[int], extrapolate: int):
...
# @torch.jit.script
def grid_hess(inp, grid, bound: List[int], interpolation: List[int], extrapolate: int):
    """Used only in backward pass of grid_grad
    inp: (B, C, *spatial_in) tensor
    grid: (B, *spatial_out, D) tensor
    bound: List{D}[int] tensor
...
def grid_pull_backward(
    grad, inp, grid, bound: List[int], interpolation: List[int], extrapolate: int
...
# @torch.jit.script
def grid_count_backward(grad, grid, bound: List[int], interpolation: List[int], extrapolate: int) -> Optional[Tensor]:
    """
    grad: (B, C, *spatial_out) tensor
    grid: (B, *spatial_in, D) tensor
    bound: List{D}[int] tensor
